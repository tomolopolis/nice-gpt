...
def print_HTML(text: str, **kwargs) -> None:
    ...
    try:
        ...
        try:
            ...
            print("[Could not properly parse text. This is a medchain error, please open an issue.]", text, kwargs)
...
def prompt_HTML(session: PromptSession, prompt: str, **kwargs) -> str:
    ...
    try:
        ...
        try:
            ...
            print("[Could not properly parse text. This is a medchain error, please open an issue.]", prompt, kwargs)
